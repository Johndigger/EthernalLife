...
public class ItemVirtualBeddleStation extends ItemBed {
    ...
    public boolean onItemUse(ItemStack par1ItemStack,
        ...
        if (par3World.isRemote) {
            ...
            ++par5;
            BlockVirtualBeddleStation blockbed = (BlockVirtualBeddleStation) EthernalLife.blockVirtualBeddleStation;
            int i1 = MathHelper
            ...
            if (par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7,
                    par1ItemStack)
                    && par2EntityPlayer.canPlayerEdit(par4 + b0, par5, par6
                            + b1, par7, par1ItemStack)) {
                if (par3World.isAirBlock(par4, par5, par6)
                        && par3World.isAirBlock(par4 + b0, par5, par6 + b1)
                        && par3World.doesBlockHaveSolidTopSurface(par4,
                                par5 - 1, par6)
                        && par3World.doesBlockHaveSolidTopSurface(par4 + b0,
                                par5 - 1, par6 + b1)) {
                    par3World.setBlock(par4, par5, par6, blockbed.blockID, i1,
                            3);

                    if (par3World.getBlockId(par4, par5, par6) == blockbed.blockID) {
                        par3World.setBlock(par4 + b0, par5, par6 + b1,
                                blockbed.blockID, i1 + 8, 3);
                    }
